...
Я энтузиаст в области **системного инжиниринга**, **администрирования баз данных** и **сетевых технологий**.  
Увлекаюсь DevOps и машинным обучением.  


## 💼 Интересы и направления

- 🖥️ Системная инженерия  
- 🗄️ Администрирование баз данных (Clickhouse, PostgreSQL, MySQL, Orcale)  
- 🌐 Сетевые технологии и инфраструктура  
- ⚙️ Автоматизация и DevOps-подходы  
